...
#include <stdlib.h>
#include <string.h>
#define USERNAME "nahin"
#define PASSWORD "nahin081"
#define MAX 20
...
void login()
{
    ...
    while (1)
    {
        if ((strcmp(USERNAME, username)) == 0 && (strcmp(PASSWORD, password)) == 0)
        {
            ...
            printf("\033[0m");
            //printf("\v\v\t\t\t--Welcome to the NAHINVAI Departmental Store--\n");
            options();
        }
        else
        {
...
//     for (i = 1; i <= 10; i++)
//         printf("-");
//     printf(" NAHINVAI DEPARTMENTAL STORE");
//     for (i = 1; i <= 10; i++)
//         printf("-");
//     printf("\n\n");
